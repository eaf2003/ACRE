Public Class Walkin
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        winID = Acreditaciones.oReservas.AgregarWalkIn(TextBox1.Text, ComboBox1.Text, "WI- Walk In", MaskedTextBox2.Text, MaskedTextBox1.Text, 0, ComboBox2.Text, TextBox4.Text)
        Acreditaciones.CargarComparador()
        Acreditaciones.CargarListaSinBuscar(Acreditaciones.ListView1)
        Acreditaciones.CargarFicha(winID)
        Acreditaciones.ImprimirToken()
    ...
    Public Sub New()
        ...
        ComboBox1.DataSource = Acreditaciones.ComboBox1.Items
